    ...
    <section className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8 max-w-2xl">
        ...
        <p className="mt-4 text-muted-foreground">
          This version uses a lightweight SVG graph, so it does not depend on a heavy graph canvas library. That makes the Next.js version easier to debug and deploy.
        </p>
      </div>
